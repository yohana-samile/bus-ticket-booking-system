...
!function () {
    ...
    var e, t, n, r, i, a, u, s, c, l, f, m, g, p, h, v, b, y = function (n) {
        ...
        }, C = j(!1), x = j(!0), w = C, N = x, E = function () {
            return S
        }, S = (r = {
            fold: function (e, t) {
                return e()
            }, is: w, isSome: w, isNone: N, getOr: n = function (e) {
                return e
                ...
                return undefined
            }, or: n, orThunk: t, map: E, ap: E, each: function () {
            }, bind: E, flatten: E, exists: w, forall: N, filter: E, equals: e = function (e) {
                return e.isNone()
            }, equals_: e, toArray: function () {
                return []
            }, toString: j("none()")
        }, Object.freeze && Object.freeze(r), r), k = function (n) {
            var e = function () {
                return n
            }, t = function () {
                return o
        ...
        }, R = T("string"), _ = T("object"), D = T("array"), B = T("null"), O = T("boolean"), P = T("function"),
        L = T("number"), I = (i = Array.prototype.indexOf) === undefined ? function (e, t) {
            return X(e, t)
        } : function (e, t) {
            return i.call(e, t)
        }, M = function (e, t) {
    ...
    var fe, de = {
        ...
        }, setTimeout: ge, setInterval: pe, setEditorTimeout: function (e, t, n) {
            return ge(function () {
                e.removed || t()
            }, n)
        ...
        }, debounce: he, throttle: he, clearInterval: function (e) {
            return clearInterval(e)
        }, clearTimeout: function (e) {
            return clearTimeout(e)
        }
    }, be = /^(?:mouse|contextmenu)|click/, ye = {
        keyLocation: 1,
        layerX: 1,
        layerY: 1,
        returnValue: 1,
        ...
        b.bind = function (e, t, n, r) {
            ...
            if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
                for (e[g] ? o = e[g] : (o = m++, e[g] = o, y[o] = {}), r = r || e, a = (t = t.split(" ")).length; a--;) c = d, s = l = !1, "DOMContentLoaded" === (u = t[a]) && (u = "ready"), b.domLoaded && "ready" === u && "complete" === e.readyState ? n.call(r, Ee({type: u})) : (h || (s = v[u]) && (c = function (e) {
                    var t, n;
    ...
    var Te, Ae, Re, _e, De, Be, Oe, Pe, Le, Ie, Me, Fe, ze, Ue, Ve, He, je, qe, $e = "sizzle" + -new Date,
        We = window.document, Ke = 0, Xe = 0, Ye = Tt(), Ge = Tt(), Je = Tt(), Qe = function (e, t) {
            return e === t && (Me = !0), 0
        }, Ze = typeof undefined, et = {}.hasOwnProperty, tt = [], nt = tt.pop, rt = tt.push, ot = tt.push, it = tt.slice,
    ...
    for (Te in Ae = kt.support = {}, De = kt.isXML = function (e) {
        ...
        pseudos: {
            not: At(function (e) {
                ...
                return ht.test(n || "") || kt.error("unsupported lang: " + n), n = n.replace(Et, St).toLowerCase(), function (e) {
                    var t;
                    do {
    ...
    function Ut(e) {
        ...
        }]; u < o; u++) if (t = Re.relative[e[u].type]) l = [It(Mt(l), t)]; else {
    ...
    Pt.prototype = Re.filters = Re.pseudos, Re.setFilters = new Pt, Be = kt.tokenize = function (e, t) {
        ...
        if (!a) {
            ...
            (a = Je(e, (h = i, b = 0 < (v = o).length, y = 0 < h.length, r = function (e, t, n, r, o) {
                var i, a, u, s = 0, c = "0", l = e && [], f = [], d = Le, m = e || y && Re.find.TAG("*", o),
        ...
        var o, i, a, u, s, c = "function" == typeof e && e, l = !r && Be(e = c.selector || e);
        if (n = n || [], 1 === l.length) {
            ...
            for (o = vt.needsContext.test(e) ? 0 : i.length; o-- && (a = i[o], !Re.relative[u = a.type]);) if ((s = Re.find[u]) && (r = s(a.matches[0].replace(Et, St), wt.test(i[0].type) && Ot(t.parentNode) || t))) {
    ...
    var Vt = Array.isArray, Ht = function (e, t, n) {
            var r, o;
            if (!e) return 0;
            ...
            isArray: Vt, toArray: function (e) {
                ...
                return n
            }, findIndex: jt, find: function (e, t, n) {
                var r = jt(e, t, n);
            ...
            trim: Wt, isArray: qt.isArray, is: Kt, toArray: qt.toArray, makeMap: function (e, t, n) {
                var r;
                for (t = t || ",", "string" == typeof (e = e || []) && (e = e.split(t)), n = n || {}, r = e.length; r--;) n[e[r]] = {};
                return n
            }, each: qt.each, map: qt.map, grep: qt.filter, inArray: qt.indexOf, hasOwn: function (e, t) {
        ...
        Zt = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, en = ke.Event, tn = Yt.makeMap("children,contents,next,prev"),
        nn = function (e) {
            return void 0 !== e
        }, rn = function (e) {
    ...
    var Sn, kn, Tn, An = function (e, t) {
            ...
            firefox: j(Bn),
            safari: j("Safari")
        }, In = "Windows", Mn = "Android", Fn = "Solaris", zn = "FreeBSD", Un = function (e, t) {
            return function () {
                return t === e
            }
        }, Vn = function (e) {
        ...
        }, Yn = /.*?version\/\ ?([0-9]+)\.([0-9]+).*/, Gn = function (t) {
            return function (e) {
                return Wn(e, t)
            }
        }, Jn = [{
            ...
            name: "Chrome", versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/, Yn], search: function (e) {
            ...
            name: "Safari", versionRegexes: [Yn, /.*?cpu os ([0-9]+)_([0-9]+).*/], search: function (e) {
            ...
            search: Gn("sunos"),
            versionRegexes: []
        }, {name: "FreeBSD", search: Gn("freebsd"), versionRegexes: []}], Zn = {browsers: j(Jn), oses: j(Qn)},
        er = function (e) {
            var t, n, r, o, i, a, u, s, c, l, f, d = Zn.browsers(), m = Zn.oses(), g = qn(d, e).fold(Ln.unknown, Ln.nu),
            ...
            fromHtml: function (e, t) {
                ...
                return nr(n)
            }, fromDom: nr, fromPoint: function (e, t, n) {
                var r = e.dom();
        ...
        ir = (Node.DOCUMENT_TYPE_NODE, Node.DOCUMENT_FRAGMENT_NODE, Node.ELEMENT_NODE), ar = Node.TEXT_NODE,
        ur = (Node.PROCESSING_INSTRUCTION_NODE, Node.ENTITY_REFERENCE_NODE, Node.ENTITY_NODE, Node.NOTATION_NODE, function (e) {
        ...
        }, cr = sr(ir), lr = sr(ar), fr = Object.keys, dr = Object.hasOwnProperty, mr = function (e, t) {
        ...
        }, $r = (Er("element", "offset"), tr.detect().browser), Wr = function (e) {
            return V(e, cr)
        }, Kr = {
            ...
            return {
                is: function (e) {
                    return n === e
                }, isValue: x, isError: C, getOr: j(n), getOrThunk: j(n), getOrDie: j(n), or: function (e) {
                    return eo(n)
                }, orThunk: function (e) {
                    return eo(n)
                }, fold: function (e, t) {
            ...
            return {
                is: C, isValue: C, isError: x, getOr: q, getOrThunk: function (e) {
                    return e()
                }, getOrDie: function () {
                    ...
                    return to(n)
                }, exists: C, forall: x, toOption: A.none
            }
    ...
    var oo, io, ao, uo = function (t) {
        ...
        }, Eo = Co(3), So = Co(8), ko = Co(9), To = wo("br"), Ao = No("true"), Ro = No("false"), _o = {
            isText: Eo,
            isElement: xo,
            isComment: So,
            isDocument: ko,
        ...
        }, Oo = {trimNode: Bo}, Po = Yt.makeMap,
        Lo = /[&<>\"\u0060\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
        Io = /[<>&\u007E-\uD7FF\uE000-\uFFEF]|[\uD800-\uDBFF][\uDC00-\uDFFF]/g, Mo = /[<>&\"\']/g,
        Fo = /&#([a-z0-9]+);?|&([a-z0-9]+);/gi, zo = {
            128: "\u20ac",
            130: "\u201a",
            131: "\u0192",
            132: "\u201e",
    ...
    var Vo = function (e, t) {
        ...
        }, $o = {}, Wo = {}, Ko = Yt.makeMap, Xo = Yt.each, Yo = Yt.extend, Go = Yt.explode, Jo = Yt.inArray,
        Qo = function (e, t) {
            ...
            var r;
            return e && (r = {}, "string" == typeof e && (e = {"*": e}), Xo(e, function (e, t) {
    ...
    function ti(i) {
        ...
        var S = function (e) {
            ...
            var t, n, r, o, i, a, u, s, c, l, f, d, m, g, p, h, v, b, y,
                C = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)\])?$/,
                x = /^([!\-])?(\w+[\\:]:\w+|[^=:<]+)?(?:([=:<])(.*))?$/, w = /[*?+]/;
            if (e) for (e = Qo(e, ","), N["@"] && (h = N["@"].attributes, v = N["@"].attributesOrder), t = 0, n = e.length; t < n; t++) if (i = C.exec(e[t])) {
                ...
                if (s) for (r = 0, o = (s = Qo(s, "|")).length; r < o; r++) if (i = x.exec(s[r])) {
            ...
            $o[i.schema] = null, e && Xo(Qo(e, ","), function (e) {
                var t, n, r = o.exec(e);
                r && (n = r[1], t = n ? g[r[2]] : g[r[2]] = {"#comment": {}}, t = g[r[2]], Xo(Qo(r[3], "|"), function (e) {
                    "-" === n ? delete t[e] : t[e] = {}
                }))
            })
        }, w = function (e) {
    ...
    var oi, ii = Yt.each, ai = Yt.grep, ui = de.ie, si = /^([a-z0-9],?)+$/i, ci = /^[ \t\r\n]*$/,
        li = function (n, r, o) {
    ...
    function mi(a, u) {
        ...
        var r = {}, i = window, o = {}, t = 0, e = function (m, g) {
            ...
            }(a, {contentCssCors: u.contentCssCors}), l = [], f = u.schema ? u.schema : ti({}),
            d = ri({url_converter: u.url_converter, url_converter_scope: u.url_converter_scope}, u.schema),
            m = u.ownEvents ? new ke(u.proxy) : ke.Event, n = f.getBlockElements(),
            ...
            }, B = qo.decode, O = qo.encodeAllRaw, P = function (e, t) {
                var n = h(e);
    ...
    var gi = mi, pi = gi.DOM, hi = Yt.each, vi = Yt.grep, bi = function (e) {
    ...
    var ji, qi = function (e, t, n) {
        ...
        }, Yi = j("mce-annotation"), Gi = j("data-mce-annotation"), Ji = j("data-mce-annotation-uid"),
        Qi = function (r, e) {
            var t = r.selection.getRng(), n = rr.fromDom(t.startContainer), o = rr.fromDom(r.getBody()),
                i = e.fold(function () {
                    return "." + Yi()
                }, function (e) {
                    return "[" + Gi() + '="' + e + '"]'
                }), a = Hr(n, t.startOffset).getOr(n), u = Xi(a, i, function (e) {
                    return Or(e, o)
                }), s = function (e, t) {
            ...
            var n, r, o, a = Bi({}), c = function (e, t) {
                ...
                var e, t, n, r = a.get(), o = (e = fr(r), (n = Q.call(e, 0)).sort(t), n);
                F(o, function (e) {
                    u(e, function (u) {
            ...
            var n, r, o = Lr(e).dom(), i = rr.fromDom(o.createDocumentFragment()),
        ...
        }, fa = _o.isElement, da = _o.isText, ma = function (e) {
            ...
            var t, n
        }, Na = _o.isContentEditableTrue, Ea = _o.isContentEditableFalse, Sa = _o.isBr, ka = _o.isText,
        Ta = _o.matchNodeNames("script style textarea"),
        Aa = _o.matchNodeNames("img input textarea hr iframe video audio object"), Ra = _o.matchNodeNames("table"),
        _a = pa, Da = function (e) {
        ...
        }, Xa = _o.isElement, Ya = Da, Ga = _o.matchStyleValues("display", "block table"),
        Ja = _o.matchStyleValues("float", "left right"), Qa = Wa(Xa, Ya, y(Ja)),
        Za = y(_o.matchStyleValues("white-space", "pre pre-line pre-wrap")), eu = _o.isText, tu = _o.isBr,
        nu = gi.nodeIndex, ru = Va, ou = function (e) {
            ...
            if (Xa(e.container())) if (e.isAtEnd()) n = ru(e.container(), e.offset()), eu(n) && i(n, n.data.length), Qa(n) && !tu(n) && o(lu(cu(n), !1)); else {
    ...
    var mu, gu, pu, hu = du, vu = _o.isText, bu = _o.isBogus, yu = gi.nodeIndex, Cu = function (e) {
            var t = e.parentNode;
            return bu(t) ? Cu(t) : t
        }, xu = function (e) {
        ...
        }, ku = _o.isContentEditableFalse, Tu = function (e, t, n, r, o) {
            ...
            getBookmark: function (e, t, n) {
                ...
                }) : t ? {rng: e.getRng()} : Lu(e, !1);
                var r, o
            }, getUndoBookmark: d(Ou, q, !0), getPersistentBookmark: Lu
        }, Mu = "_mce_caret", Fu = function (e) {
            ...
            return null
        }, Uu = _o.isElement, Vu = _o.isText, Hu = function (e) {
            var t = e.parentNode;
            t && t.removeChild(e)
        }, ju = function (e, t) {
        ...
        }, Gu = tr.detect().browser, Ju = _o.isContentEditableFalse, Qu = function (e, t, n) {
        ...
        as = _o.matchStyleValues("display", "block table table-cell table-caption list-item"), us = pa, ss = ma,
        cs = _o.isElement, ls = Da, fs = function (e) {
            return 0 < e
        }, ds = function (e) {
            return e < 0
        }, ms = function (e, t) {
            ...
            return null
        }, Cs = d(bs, !0), xs = d(bs, !1), ws = function (e, t, n) {
            var r, o, i, a, u = d(ys, !0, t), s = d(ys, !1, t);
    ...
    var Ls, Is, Ms, Fs, zs, Us = _o.isContentEditableFalse, Vs = _o.isText, Hs = _o.isElement, js = _o.isBr, qs = Da,
        $s = function (e) {
        ...
        }, rc = d(tc, !0), oc = d(tc, !1), ic = {
            fromPosition: tc, nextPosition: rc, prevPosition: oc, navigate: function (t, n, r) {
                return tc(t, n, r).bind(function (e) {
                    return hs(r, e, n) && ec(t, r, e) ? tc(t, n, e) : A.some(e)
                })
            }, positionIn: nc, firstPositionIn: d(nc, !0), lastPositionIn: d(nc, !1)
        }, ac = function (e, t) {
            ...
            isInlineBlock: hc, moveStart: function (e, t, n) {
                var r, o, i, a = n.startOffset, u = n.startContainer;
                if ((n.startContainer !== n.endContainer || !hc(n.startContainer.childNodes[n.startOffset])) && 1 === u.nodeType) for (a < (i = u.childNodes).length ? r = new ro(u = i[a], e.getParent(u, e.isBlock)) : (r = new ro(u = i[i.length - 1], e.getParent(u, e.isBlock))).next(!0), o = r.current(); o; o = r.next()) if (3 === o.nodeType && !vc(o)) return n.setStart(o, 0), void t.setRng(n)
            ...
            }, isWhiteSpaceNode: vc, replaceVars: function (e, n) {
            ...
            }, normalizeStyleValue: bc, getStyle: function (e, t, n) {
        ...
        }, Cc = pc, xc = yc.getParents, wc = yc.isWhiteSpaceNode, Nc = yc.isTextBlock, Ec = function (e, t) {
            ...
            for (a = new ro(n, e.getParent(n, e.isBlock) || t); u = a[o ? "prev" : "next"]();) if (3 !== u.nodeType || Cc(u.parentNode)) {
            ...
            var i, a, u, s;
            for (3 === r.nodeType && 0 === r.nodeValue.length && r[o] && (r = r[o]), i = xc(e, r), a = 0; a < i.length; a++) for (u = 0; u < t.length; u++) if (!("collapsed" in (s = t[u]) && s.collapsed !== n.collapsed) && e.is(i[a], s.selector)) return i[a];
            return r
        }, Rc = function (t, e, n, r) {
            ...
            var a = [], u = Mc(i.getDoc(), r, t, n), s = Bi(A.none()), c = function () {
                s.set(A.none())
            }, l = function (e) {
                F(e, o)
            }, o = function (e) {
            ...
            s.undoManager.transact(function () {
                ...
                if (o.collapsed && (r = Dc(e = s, t = o, [{inline: !0}], 3 === (n = t).startContainer.nodeType && n.startContainer.nodeValue.length >= n.startOffset && "\xa0" === n.startContainer.nodeValue[n.startOffset]), t.setStart(r.startContainer, r.startOffset), t.setEnd(r.endContainer, r.endOffset), e.selection.setRng(t)), s.selection.getRng().collapsed) {
                    var i = Mc(s.getDoc(), f, c, l.decorate);
                    aa(i, "\xa0"), s.selection.getRng().insertNode(i.dom()), s.selection.select(i.dom())
                } else {
                    var a = Iu.getPersistentBookmark(s.selection, !1), u = s.selection.getRng();
    ...
    function Uc(s) {
        ...
        return {
            register: function (e, t) {
                ...
                var t, n, r, o, i, a,
                    u = (t = s, n = e, r = rr.fromDom(t.getBody()), o = Vi(r, "[" + Gi() + '="' + n + '"]'), i = {}, F(o, function (e) {
                        var t = br(e, Ji()), n = i.hasOwnProperty(t) ? i[t] : [];
                        i[t] = n.concat([e])
                    }), i);
                return a = function (e) {
                    return $(e, function (e) {
    ...
    var Vc = function (e) {
        ...
        var n = hu.after(e), r = Gs(t).prev(n);
        ...
        var n, r, a, u, s, c, l, f, d, m, g, p, h, v, b, y, C, x, w,
            ...
            E = qc(o, i.startContainer), S = jc(Vc(N.firstChild)), k = o.getRoot(), T = function (e) {
                var t = hu.fromRangeStart(i), n = Gs(o.getRoot()), r = 1 === e ? n.prev(t) : n.next(t);
    ...
    var ol = function (a) {
            var u = hu.fromRangeStart(a), s = hu.fromRangeEnd(a), c = a.commonAncestorContainer;
        ...
        }, al = _o.matchNodeNames("td th"), ul = function (e, t) {
            ...
            }(g.getRng(), t)), r = e.parser, m = n.merge, o = rl({validate: e.settings.validate}, e.schema), d = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>', s = {
                content: t,
                format: "html",
                selection: !0,
                paste: n.paste
        ...
        }, ll = Er("sections", "settings"), fl = tr.detect().deviceType.isTouch(), dl = ["lists", "autolink", "autosave"],
        ml = {theme: "mobile"}, gl = function (e) {
            var t = D(e) ? e.join(" ") : e, n = $(R(t) ? t.split(" ") : [], Kn);
            ...
            var o, i = gl(n.forced_plugins), a = gl(r.plugins), u = e && hl(t, "mobile") ? z(a, d(M, dl)) : a,
            ...
            return qa([ic.firstPositionIn(u), ic.lastPositionIn(u)], function (e, t) {
                var n = El.normalizePosition(!0, e), r = El.normalizePosition(!1, t), o = El.normalizePosition(!1, a);
            ...
            var n, r, o, i = rr.fromDom(e), a = rr.fromDom(t);
            ...
            var n, r, o
        }, _l = _o.hasAttribute("data-mce-bookmark"), Dl = _o.hasAttribute("data-mce-bogus"),
        Bl = _o.hasAttributeValue("data-mce-bogus", "all"), Ol = function (e) {
            return function (e) {
                var t, n, r = 0;
                if (Rl(e, e)) return !1;
                ...
                t = new ro(n, e);
                do {
                    if (Bl(n)) n = t.next(!0); else if (Dl(n)) n = t.next(); else if (_o.isBr(n)) r++, n = t.next(); else {
                        if (Rl(e, n)) return !1;
                        n = t.next()
                    }
                } while (n);
        ...
        }, Pl = Er("block", "position"), Ll = Er("from", "to"), Il = function (e, t) {
            var n = rr.fromDom(e), r = rr.fromDom(t.container());
            return Sl(n, r).map(function (e) {
                return Pl(e, t)
            })
        }, Ml = function (o, i, e) {
            var t = Il(o, hu.fromRangeStart(e)), n = t.bind(function (e) {
            ...
            return Pr(t, e) ? function (e, t) {
                for (var n = P(t) ? t : j(!1), r = e.dom(), o = []; null !== r.parentNode && r.parentNode !== undefined;) {
                    var i = r.parentNode, a = rr.fromDom(i);
            ...
            var n, r, o, t, i = rr.fromDom(e.getBody()), a = e.selection.getRng();
            ...
            var r = z(Hl(rr.fromDom(n.container()), t), co), o = ee(r).getOr(t);
        ...
        ff = function (e, t, n, r) {
            ...
            void 0 === r && (r = !0);
            var o, i = xf(n, t.getBody(), e.dom()), a = qi(e, d(Nf, t), (o = t.getBody(), function (e) {
                return e.dom() === o
            })), u = Sf(e, i, kf(t, e));
        ...
        }, Mf = d(If, !0), Ff = d(If, !1), zf = function (e, t) {
        ...
        qf = function (e, t) {
            ...
            var r = El.normalizeForwards(n), o = qf(t, r.container());
            ...
            var r = El.normalizeBackwards(n), o = qf(t, r.container());
            return El.findRootInline(e, o, r).fold(function () {
            ...
            var e = El.normalizePosition(a, c), l = Qf(u, s, e);
        ...
        }, ad = Qf, ud = id, sd = (d(id, !1), d(id, !0), td), cd = function (e) {
            ...
            var n = t.selection.getRng(), r = e ? hu.fromRangeEnd(n) : hu.fromRangeStart(n);
            ...
            }, moveNextWord: d(vd, !0), movePrevWord: d(vd, !1), setupSelectedState: function (a) {
                var u = Bi(null), s = d(El.isInlineTarget, a);
            ...
            var u = r.getBody(), s = d(El.isInlineTarget, r);
            ...
            var e, t, a = (e = n.getBody(), t = o.container(), ps(t, e) || e), u = d(El.isInlineTarget, n), s = ad(u, a, o);
            return s.bind(function (e) {
                ...
                var t = ic.navigate(i, a, o), e = t.bind(function (e) {
                    return ad(u, a, e)
                });
                return s.isSome() && e.isSome() ? El.findRootInline(u, a, o).map(function (e) {
                    return o = e, !!qa([ic.firstPositionIn(o), ic.lastPositionIn(o)], function (e, t) {
                        var n = El.normalizePosition(!0, e), r = El.normalizePosition(!1, t);
            ...
            return !1
        }, Nd = Er("start", "end"), Ed = Er("rng", "table", "cells"),
        Sd = nf([{removeTable: ["element"]}, {emptyCells: ["cells"]}]), kd = function (e, t) {
            ...
            var t = kd(e.startContainer, r), n = kd(e.endContainer, r);
            ...
            var n, r, o, i, a, u = rr.fromDom(e.selection.getStart(!0)), s = $d(e);
            ...
            getFontSize: Dm("font-size"), getFontFamily: H(function (e) {
                return e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")
            }, Dm("font-family")), toPt: function (e, t) {
            ...
            var n = t.collapsed, r = t.cloneRange(), o = du.fromRangeStart(t);
        ...
        ng = (eg.domRange, eg.relative, eg.exact, tr.detect().browser), rg = function (e, t) {
        ...
        }, Cg = Yt.each, xg = Yt.extend, wg = Yt.map, Ng = Yt.inArray;
    ...
    var Tg, Ag = function (n) {
            ...
            var e, t;
            if (i.delegates || (i.delegates = {}), !i.delegates[a] && !i.removed) if (e = Vg(i, a), i.settings.event_root) {
        ...
        }, $g = qg = Yt.extend({}, Rg, qg), Wg = Yt.each, Kg = Yt.explode, Xg = {f9: 120, f10: 121, f11: 122},
    ...
    var Jg = function (e) {
        ...
        }, ap = rp, up = function (e, t) {
            return t.dom()[e]
        }, sp = function (e, t) {
            return parseInt(wr(t, e), 10)
        }, cp = d(up, "clientWidth"), lp = d(up, "clientHeight"), fp = d(sp, "margin-top"), dp = d(sp, "margin-left"),
        mp = function (e, t, n) {
    ...
    var vp = wi.PluginManager, bp = function (e, t) {
        var n = function (e, t) {
    ...
    }, Sp = wi.PluginManager, kp = wi.ThemeManager;
    ...
    }, Pp = _p, Lp = 0, Ip = function (e) {
        return (e || "blobid") + Lp++
    }, Mp = function (n, r, o, t) {
        var i, a;
        0 !== r.src.indexOf("blob:") ? (i = Pp(r.src).data, (a = n.findFirst(function (e) {
            return e.base64() === i
        })) ? o({image: r, blobInfo: a}) : Bp(r.src).then(function (e) {
            a = n.create(Ip(), e, i), n.add(a), o({image: r, blobInfo: a})
        }, function (e) {
            t(e)
        })) : (a = n.getByUri(r.src)) ? o({image: r, blobInfo: a}) : Bp(r.src).then(function (t) {
    ...
    function Vp(u) {
        ...
        return u.on("setContent", function () {
            ...
            blobCache: l, addFilter: function (e) {
                d.push(e)
            }, uploadImages: y, uploadImagesAuto: C, scanForImages: w, destroy: function () {
    ...
    var Hp = function (e, t) {
        ...
        if (f = d.forced_root_block, v && _o.isElement(v) && f && (l = b.nodeName.toLowerCase(), p.isValidChild(l, f.toLowerCase()) && !jp(h, b, v))) {
            for (n = (t = g.getRng()).startContainer, r = t.startOffset, o = t.endContainer, i = t.endOffset, c = ap(e), v = b.firstChild; v;) if (y = h, C = v, _o.isText(C) || _o.isElement(C) && !Hp(y, C) && !pc(C)) {
                if (qp(h, v)) {
        ...
        return qa([(i = e, a = i.startContainer, u = i.startOffset, _o.isText(a) ? 0 === u ? A.some(rr.fromDom(a)) : A.none() : A.from(a.childNodes[u]).map(rr.fromDom)), (t = e, n = t.endContainer, r = t.endOffset, _o.isText(n) ? r === n.data.length ? A.some(rr.fromDom(n)) : A.none() : A.from(n.childNodes[r - 1]).map(rr.fromDom))], function (e, t) {
            var n = V(Kp(o), d(Or, e)), r = V(Xp(o), d(Or, t));
            return n.isSome() && r.isSome()
        }).getOr(!1);
        var t, n, r, i, a, u
    }, Gp = function (e, t, n, r) {
        var o = n, i = new ro(n, o), a = e.schema.getNonEmptyElements();
        do {
    ...
    var Zp, eh, th = function (e) {
        ...
        var n, r, o, i, a, u
    }, rh = _o.isContentEditableFalse, oh = _o.isContentEditableTrue, ih = function (e) {
    ...
    var dh = function (o, i, a, e, u, t) {
        var n, s, c = 0, l = [], r = function (e) {
            var t, n, r;
            for (r = fh([e]), -1 === o && (r = r.reverse()), t = 0; t < r.length; t++) if (n = r[t], !a(n, s)) {
    ...
    }, mh = d(dh, Zp.Up, Fa, za), gh = d(dh, Zp.Down, za, Fa), ph = function (n) {
        return function (e) {
            return t = n, e.line > t;
            var t
        }
    ...
    }, vh = _o.isContentEditableFalse, bh = gs, yh = function (e, t) {
        ...
        var r, o, i, a, u, s, c, l = fh(z(ne(e.getElementsByTagName("*")), ts)), f = z(l, function (e) {
    ...
    }, kh = _o.isContentEditableTrue, Th = _o.isContentEditableFalse, Ah = function (e, t, n, r, o) {
        ...
        var r = ws(1, e.getBody(), t), o = hu.fromRangeStart(r), i = o.getNode();
    ...
    }, Ph = _o.isContentEditableTrue, Lh = _o.isContentEditableFalse, Ih = As, Mh = Ts, Fh = function (e, t) {
        ...
        var p, e, t, a = g.getBody(), o = Zu(g.getBody(), function (e) {
        ...
        return de.ceFalse && (function () {
            ...
            var n, r, i = function (e, t) {
                ...
                return !(!o || !g.dom.isChildOf(o, i) || !1 !== Lh(Fh(g, o))) || o && (n = o, r = i, !(g.dom.getParent(n, g.dom.isBlock) === g.dom.getParent(r, g.dom.isBlock))) && function (e) {
                    ...
                    var n = hu.before(e.firstChild), r = t.next(n);
                    return r && !Mh(r) && !Ih(r)
                }(o)
            };
            r = !1, (n = g).on("touchstart", function () {
                ...
                var t, n = e.target;
                if ((n === a || "HTML" === n.nodeName || g.dom.isChildOf(n, a)) && !1 !== mp(g, e.clientX, e.clientY)) if (t = Fh(g, n)) Lh(t) ? (e.preventDefault(), c(Rh(g, t))) : (l(), Ph(t) && e.shiftKey || Sh(e.clientX, e.clientY, g.selection.getRng()) || (C(), g.selection.placeCaretAt(e.clientX, e.clientY))); else if (!1 === ts(n)) {
                    l(), C();
        ...
        return {
            parse: function (e) {
                ...
                for (S = new RegExp("<(?:(?:!--([\\w\\W]*?)--\x3e)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)>)|(?:([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), k = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, s = z.getShortEndedElements(), E = F.self_closing_elements || z.getSelfClosingElements(), g = z.getBoolAttrs(), p = F.validate, u = F.remove_internals, R = F.fix_self_closing, T = z.getSpecialElements(), N = e + ">"; t = S.exec(N);) {
                    if (_ < t.index && H(O(e.substr(_, t.index - _))), n = t[6]) ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), I(n); else if (n = t[7]) {
    ...
    var Hh = Vh, jh = function (e, t) {
        ...
        return la(l)
    }, qh = {trimExternal: jh, trimInternal: jh}, $h = 0, Wh = 2, Kh = 1, Xh = function (g, p) {
    ...
    var sv, cv, lv = yc.isEq, fv = function (e, t, n) {
        ...
        if (c && t) for (a = 0; a < c.length; a++) if (i = c[a], mv(e.dom, t, i) && gv(l, t, i, "attributes", o, r) && gv(l, t, i, "styles", o, r)) {
            if (s = i.classes) for (u = 0; u < s.length; u++) if (!e.dom.hasClass(t, s[u])) return;
            return i
        }
    }, hv = {
        matchNode: pv, matchName: mv, match: function (e, t, n, r) {
            var o;
            ...
            if (u) for (n = e.selection.getStart(), r = yc.getParents(s, n), i = u.length - 1; 0 <= i; i--) {
    ...
    }, yv = ca, Cv = "_mce_caret", xv = function (e) {
        return 0 < function (e) {
            for (var t = []; e;) {
        ...
        if (xv(t)) Tf(e, !1, rr.fromDom(t), n); else {
        ...
        if (t) Ev(e, t, n); else if (!(t = zu(e.getBody(), o.getStart()))) for (; t = r.get(Cv);) Ev(e, t, !1)
    }, kv = function (e, t, n) {
        var r = e.dom, o = r.getParent(n, d(yc.isTextBlock, e));
    ...
    var Pv = function (e, t) {
    ...
    }, Lv = /^(src|href|style)$/, Iv = Yt.each, Mv = yc.isEq, Fv = function (e, t, n) {
        ...
        var i = rr.fromDom(t), a = rr.fromDom(e.create(r, o)), u = n ? Ur(i) : zr(i);
        ...
        if ("all" !== n.remove) for (Iv(n.styles, function (e, t) {
    ...
    }, qv = jv, $v = function (s, c, l, e, f) {
        var t, n, d = s.formatter.get(c), m = d[0], a = !0, u = s.dom, r = s.selection, i = function (e) {
            var n, t, r, o, i, a,
                u = (n = s, t = e, r = c, o = l, i = f, Iv(yc.getParents(n.dom, t.parentNode).reverse(), function (e) {
                    var t;
            ...
            if (e = Dc(s, e, d, !0), m.split) {
                if (e = bv(e), (t = zv(s, e, !0)) !== (n = zv(s, e))) {
                    ...
                    t = Uv(u, t, "span", {id: "_start", "data-mce-type": "bookmark"}), n = Uv(u, n, "span", {
                        id: "_end",
                        "data-mce-type": "bookmark"
                    }), i(t), i(n), t = p(!0), n = p()
                } else t = n = i(t);
        ...
        if (e) e.nodeType ? ((n = u.createRng()).setStartBefore(e), n.setEndAfter(e), o(n)) : o(e); else if ("false" !== u.getContentEditable(r.getNode())) r.isCollapsed() && m.inline && !u.select("td[data-mce-selected],th[data-mce-selected]").length ? function (e, t, n, r) {
            ...
            if (c) if (u) {
                ...
                l = zu(e.getBody(), c);
                var h = Nv(!1).dom(), v = Av(m, h);
                kv(e, h, l || c), Ev(e, l, !1), d.setCursorLocation(v, 1), f.isEmpty(c) && f.remove(c)
            }
        }(s, c, l, f) : (t = Iu.getPersistentBookmark(s.selection, !0), o(r.getRng()), r.moveToBookmark(t), m.inline && hv.match(s, c, l, r.getStart()) && yc.moveStart(u, r, r.getRng()), s.nodeChanged()); else {
            e = r.getNode();
            for (var h = 0, v = d.length; h < v && (!d[h].ceFalseOverride || !jv(s, d[h], l, e, e)); h++) ;
        }
    }, Wv = Yt.each, Kv = function (e) {
    ...
    }, ub = Yt.each, sb = function (g, p, h, r) {
            ...
            y = function (n, e) {
                ...
                l = b.inline || b.block, f = s.create(l), y(f), Oc(s, e, function (e) {
                    var a, u = function (e) {
                        ...
                        if (b.wrapper && hv.matchNode(g, e, p, h)) a = 0; else {
        ...
        if ("false" !== i.getContentEditable(n.getNode())) {
            if (b) {
                if (r) r.nodeType ? C(v, r) || ((t = i.createRng()).setStartBefore(r), t.setEndAfter(r), a(i, Dc(g, t, v), 0, !0)) : a(i, r, 0, !0); else if (o && b.inline && !i.select("td[data-mce-selected],th[data-mce-selected]").length) !function (e, t, n) {
    ...
    }, cb = {applyFormat: sb}, lb = Yt.each, fb = function (e, t, n, r, o) {
        var i, a, u, s, c, l, f, d;
        null === t.get() && (a = e, u = {}, (i = t).set({}), a.on("NodeChange", function (n) {
            var r = yc.getParents(a.dom, n.element), o = {};
    ...
    }, mb = Yt.each, gb = gi.DOM, pb = function (e, t) {
        var n, o, r, m = t && t.schema || ti({}), g = function (e) {
            var t, n, r;
        ...
        return e && "string" == typeof e ? (e = (e = e.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1"), Yt.map(e.split(/(?:>|\s+(?![^\[\]]+\]))/), function (e) {
            var t = Yt.map(e.split(/(?:~\+|~|\+)/), hb), n = t.pop();
    ...
    var wb, Nb = Object.prototype.hasOwnProperty, Eb = (wb = function (e, t) {
            return t
        }, function () {
            ...
            process: function (e, t, n) {
                ...
                }), o = "BODY" !== o.nodeName ? u.body.firstChild : u.body, s = c.doc, c.doc = u), _g(r, Eb(i, {node: o})), s && (c.doc = s), o) : t;
        ...
        }, Ub = Yt.makeMap, Vb = Yt.each, Hb = Yt.explode, jb = Yt.extend;
        ...
        var B = function (e) {
            ...
            schema: T, addAttributeFilter: function (e, n) {
                ...
                if (t.parse(e), h && m.length && (a.context ? a.invalid = !0 : function (e) {
                    ...
                    for (d = Ub("tr,td,th,tbody,thead,tfoot,table"), l = T.getNonEmptyElements(), f = T.getWhiteSpaceElements(), m = T.getTextBlockElements(), g = T.getSpecialElements(), t = 0; t < e.length; t++) if ((n = e[t]).parent && !n.fixed) if (m[n.name] && "li" === n.parent.name) {
                    ...
                    for (r = 0, o = R.length; r < o; r++) if ((s = R[r]).name in D) {
    ...
    var $b = function (e, t, n) {
        ...
        var r = n.selection ? Eb({forced_root_block: !1}, n) : n, o = e.parse(t, r);
    ...
    function Yb(e, t) {
        var a, u, s, c, l, n,
            r = (a = e, n = ["data-mce-selected"], s = (u = t) && u.dom ? u.dom : gi.DOM, c = u && u.schema ? u.schema : ti(a), a.entity_encoding = a.entity_encoding || "named", a.remove_trailing_brs = !("remove_trailing_brs" in a) || a.remove_trailing_brs, l = qb(a, c), Sb.register(l, a, s), {
                schema: c,
                addNodeFilter: l.addNodeFilter,
                addAttributeFilter: l.addAttributeFilter,
                serialize: function (e, t) {
                    var n = Eb({format: "html"}, t || {}), r = kb.process(u, e, n), o = Wb(s, r, n), i = Kb(l, o, n);
    ...
    var Jb, Qb, Zb = Gb, ey = _o.isContentEditableFalse, ty = _o.isContentEditableTrue, ny = function (r, a) {
        var u, s, c, l, f, d, m, g, p, h, v, b, i, y, C, x, w, N = a.dom, E = Yt.each, S = a.getDoc(), k = document,
        ...
        var _ = function (e) {
            ...
            var t, r, o, n, i;
            L(), F(), t = N.getPos(e, R), g = t.x, p = t.y, i = e.getBoundingClientRect(), r = i.width || i.right - i.left, o = i.height || i.bottom - i.top, u !== e && (u = e, y = C = 0), n = a.fire("ObjectSelected", {target: e}), B(e) && !n.isDefaultPrevented() ? E(l, function (n, e) {
                var t;
    ...
    }, ly = Er("element", "width", "rows"), fy = Er("element", "cells"), dy = Er("x", "y"), my = function (e, t) {
        ...
        var n, r = rr.fromDom(t.commonAncestorContainer), o = Hl(r, e), i = z(o, function (e) {
            return lo(e) || so(e)
        }), a = Cy(o, t), u = i.concat(a.length ? a : po(n = r) ? Ir(n).filter(go).fold(j([]), function (e) {
            return [n, e]
        }) : go(n) ? [n] : []);
        return $(u, oa)
    }, wy = function () {
        ...
        return (t = e, n = o[0], Wi(n, "table", d(Or, t))).bind(function (e) {
            var t = o[0], n = o[o.length - 1], r = vy(e);
        ...
        t.getInner = !0;
        var n, r, o, i, a, u, s, c,
            l = (r = t, i = (n = e).selection.getRng(), a = n.dom.create("body"), u = n.selection.getSel(), s = sy(n, Fd(u)), i.cloneContents ? (o = r.contextual ? Sy(rr.fromDom(n.getBody()), s).dom() : i.cloneContents()) && a.appendChild(o) : a.innerHTML = i.toString(), n.selection.serializer.serialize(a, r));
        ...
        var n, t, l, f, a, r = function (e, t) {
            ...
            getSelectedBlocks: function (e, t) {
                return function (e, t, n, r) {
                    var o, i, a = [];
                    if (i = e.getRoot(), n = e.getParent(n || Ry(i, t, t.collapsed), e.isBlock), r = e.getParent(r || _y(i, t, t.collapsed), e.isBlock), n && n !== i && a.push(n), n && r && n !== r) for (var u = new ro(o = n, i); (o = u.next()) && o !== r;) e.isBlock(o) && a.push(o);
    ...
    }, Iy = _o.isContentEditableFalse, My = Ua, Fy = As, zy = Ts, Uy = function (e, t) {
        for (; t = e(t);) if (t.isVisible()) return t;
        return t
    }, Vy = function (e, t, n, r) {
        var o, i, a, u, s, c, l = e === gu.Forwards, f = l ? zy : Fy;
        ...
        if (d) {
            var m = function (e, t, n, r) {
                var o, i, a, u, s, c, l = Gs(t), f = [], d = 0, m = function (e) {
        ...
        var r, o, i, a, u = Gs(e.getBody()), s = d(Uy, u.next), c = d(Uy, u.prev);
        ...
        return function () {
            var e, t, n, r, o, i, a, u, s,
                c = (t = f, r = Gs((e = l).getBody()), o = d(Uy, r.next), i = d(Uy, r.prev), a = t ? gu.Forwards : gu.Backwards, u = t ? o : i, s = e.selection.getRng(), (n = Vy(a, e, u, s)) ? n : (n = jy(e, a, s)) || null);
    ...
    var Wy = function (e, t) {
        ...
        }, Jy = d(Ky, du.isAbove, -1), Qy = d(Ky, du.isBelow, 1), Zy = d(Xy, -1, Jy), eC = d(Xy, 1, Qy),
        tC = function (e, t, n, r, o) {
        ...
        }, sC = d(uC, Jy), cC = d(uC, Qy), lC = function (e, t, n, r) {
            ...
            var o, i, a, u, s, c, l = e.selection.getRng(), f = hu.fromRangeStart(l), d = e.getBody();
            if (!t && sC(r, f)) {
            ...
            var e, r, o, i = rr.fromDom(t.getBody()), a = hu.fromRangeStart(t.selection.getRng()), u = mm(t), s = gm(t);
            ...
            i.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() && (t = i, n = a, r = e, o = tr.detect().os, SC([{
                    keyCode: Oh.RIGHT,
                    action: qy(t, !0)
                }, {keyCode: Oh.LEFT, action: qy(t, !1)}, {keyCode: Oh.UP, action: $y(t, !1)}, {
                    keyCode: Oh.DOWN,
                    action: $y(t, !0)
                }, {keyCode: Oh.RIGHT, action: gC(t, !0)}, {keyCode: Oh.LEFT, action: gC(t, !1)}, {
                    keyCode: Oh.UP,
                    action: pC(t, !1)
                }, {keyCode: Oh.DOWN, action: pC(t, !0)}, {keyCode: Oh.RIGHT, action: bd.move(t, n, !0)}, {
                    keyCode: Oh.LEFT,
                ...
                }, {keyCode: Oh.UP, action: wC(t, !1)}, {keyCode: Oh.DOWN, action: wC(t, !0)}], r).each(function (e) {
                    r.preventDefault()
                }))
            })
        }, TC = function (e) {
            ...
            var o, i, a, u, s = d(_v, t), c = $(z(r, s), function (e) {
                return e.dom()
            });
            if (0 === c.length) Tf(t, e, n); else {
                var l = (o = n.dom(), i = c, a = Nv(!1), u = Av(i, a.dom()), Ni(rr.fromDom(o), a), Ri(rr.fromDom(o)), hu(u, 0));
                t.selection.setRng(l.toRange())
            }
        }, RC = function (r, o) {
            var t, e = rr.fromDom(r.getBody()), n = rr.fromDom(r.selection.getStart()),
            ...
            o.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() && (t = o, n = i, r = e, SC([{
                    ...
                    keyCode: Oh.BACKSPACE,
                    action: EC(_C, t, !1)
                }, {keyCode: Oh.DELETE, action: EC(_C, t, !0)}], r).each(function (e) {
                    r.preventDefault()
                }))
                ...
                !1 === e.isDefaultPrevented() && (t = o, n = e, SC([{
                    keyCode: Oh.BACKSPACE,
                    action: EC(Df, t)
                }, {keyCode: Oh.DELETE, action: EC(Df, t)}], n))
            })
        }, BC = function (e) {
            ...
            if (n !== e.getBody()) {
                ...
                if (VC(n, r, !0) && VC(n, r, !1)) FC(n, "LI") ? i.insertAfter(l, UC(n)) : i.replace(l, n); else if (VC(n, r, !0)) FC(n, "LI") ? (i.insertAfter(l, UC(n)), l.appendChild(i.doc.createTextNode(" ")), l.appendChild(n)) : n.parentNode.insertBefore(l, n); else if (VC(n, r, !1)) i.insertAfter(l, UC(n)); else {
                    n = UC(n);
                    var f = a.cloneRange();
            ...
            var t, u, s, i, c, n, r, o, l, f, d, m, g, p, h, v, b, y, C, x = a.dom, w = a.schema,
                N = w.getNonEmptyElements(), E = a.selection.getRng(), S = function (e) {
                    var t, n, r, o = s, i = w.getTextInlineElements();
                    if (e || "TABLE" === f || "HR" === f ? (t = x.create(e || m), XC(a, t)) : t = c.cloneNode(!1), r = t, !1 === vm(a)) x.setAttrib(t, "style", null), x.setAttrib(t, "class", null); else do {
                        if (i[o.nodeName]) {
                            if (Fu(o)) continue;
            ...
            jm(x, E).each(function (e) {
                ...
                var i, a, u, s, c, l, f, d = t || "P", m = e.dom, g = KC(m, r);
            ...
            }(x, N, r), p = x, (h = c).normalize(), (v = h.lastChild) && !/^(left|right)$/gi.test(p.getStyle(v, "float", !0)) || p.add(h, "br"), x.isEmpty(c) && jC(c), r.normalize(), x.isEmpty(r) ? (x.remove(r), T()) : OC(a, r)), x.setAttrib(r, "id", ""), a.fire("NewBlock", {newBlock: r})))
        }, GC = function (e, t) {
            ...
            return GC(e, hm(e))
        }, ZC = nf([{br: []}, {block: []}, {none: []}]), ex = function (e, t) {
            return QC(e)
        }, tx = function (n) {
            return function (e, t) {
                return "" === mm(e) === n
            ...
            var t = mm(e), n = PC(e.dom, e.selection.getStart());
        ...
        }, gx = d(mx, "\xa0"), px = d(mx, " "), hx = function (t, n, r) {
        ...
        }, vx = d(hx, !1), bx = d(hx, !0), yx = function (e) {
            ...
            return A.some(e).filter(kx).bind(function (e) {
                var t, n = e.container(), r = n.nodeValue,
            ...
            var t, n, r = hu.fromRangeStart(e.selection.getRng()), o = rr.fromDom(e.getBody());
            if (e.selection.isCollapsed()) {
                var i = d(El.isInlineTarget, e), a = hu.fromRangeStart(e.selection.getRng());
        ...
        }, Mx = tr.detect().browser, Fx = function (t) {
            var e, n;
            e = t, n = Di(function () {
                e.composing || _x(e)
    ...
    function Ux(u) {
        var s, n, r, o = Yt.each, c = Oh.BACKSPACE, l = Oh.DELETE, f = u.dom, d = u.selection, e = u.settings,
            t = u.parser, i = de.gecko, a = de.ie, m = de.webkit, g = "data:text/mce-internal,", p = a ? "Text" : "URL",
            h = function (e, t) {
                try {
    ...
    var Vx = function (e) {
            ...
            t.on("click", function (e) {
                3 <= e.detail && function (e) {
                    var t = e.selection.getRng(), n = du.fromRangeStart(t), r = du.fromRangeEnd(t);
        ...
        }, qx = gi.DOM, $x = function (e) {
            var t;
            e.bindPendingEventDelegates(), e.initialized = !0, e.fire("init"), e.focus(!0), e.nodeChanged({initial: !0}), e.execCallback("init_instance_callback", e), (t = e).settings.auto_focus && ve.setEditorTimeout(t, function () {
                var e;
            ...
            !function (e, t, n, r) {
                ...
                e = u, (n = (t = i).settings).language && "en" !== n.language && !n.language_url && (n.language_url = t.editorManager.baseURL + "/langs/" + n.language + ".js"), n.language_url && !t.editorManager.i18n.data[n.language] && e.add(n.language_url), r = i.settings, o = a, Yt.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")), Yt.each(r.external_plugins, function (e, t) {
                    ...
                    if ((e = Yt.trim(e)) && !Sp.urls[e]) if (ow(e)) {
        ...
        }, sw = Yt.each, cw = Yt.trim,
        lw = "source protocol authority userInfo user password host port relative path directory file query anchor".split(" "),
        fw = {ftp: 21, http: 80, https: 443, mailto: 25}, dw = function (r, e) {
            var t, n, o = this;
            if (r = cw(r), t = (e = o.settings = e || {}).base_uri, /^([\w\-]+):([^\/]{2})/i.test(r) || /^\s*#/.test(r)) o.source = r; else {
                var i = 0 === r.indexOf("//");
    ...
    var mw = function (e, t, n) {
        var r, o, i, a, u;
        if (t.format = t.format ? t.format : "html", t.get = !0, t.getInner = !0, t.no_events || e.fire("BeforeGetContent", t), "raw" === t.format) r = Yt.trim(qh.trimExternal(e.serializer, n.innerHTML)); else if ("text" === t.format) r = la(n.innerText || n.textContent); else {
        ...
        e.dom.setHTML(e.getBody(), t), ap(r = e) && ic.firstPositionIn(r.getBody()).each(function (e) {
            var t = e.getNode(), n = _o.isTable(t) ? ic.firstPositionIn(t).getOr(e) : e;
        ...
        if (!e.removed) {
            ...
            r && e.save({is_removing: !0}), e.removed = !0, e.unbindAllNativeEvents(), e.hasHiddenInput && o && yw.remove(o.nextSibling), !e.inline && r && (i = e, yw.setStyle(i.id, "display", i.orgDisplay)), Bg(e), e.editorManager.remove(e), yw.remove(e.getContainer()), Cw(t), Cw(n), e.destroy()
        }
        var i
    }, ww = function (e, t) {
    ...
    }, Nw = gi.DOM, Ew = Yt.extend, Sw = Yt.each, kw = Yt.resolve, Tw = de.ie, Aw = function (e, t, n) {
    ...
    var Rw, _w, Dw, Bw = {
        ...
        }, qw = gi.DOM, $w = Yt.explode, Ww = Yt.each, Kw = Yt.extend, Xw = 0, Yw = !1, Gw = [], Jw = [],
        Qw = function (t) {
    ...
    Kw(Dw = {
        ...
        setup: function () {
            var e, t, n, r, o = "";
            if (t = dw.getDocumentBaseUrl(document.location), /^[^:]+:\/\/\/?[^\/]+\//.test(t) && (t = t.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, ""), /[\/\\]$/.test(t) || (t += "/")), n = window.tinymce || window.tinyMCEPreInit) e = n.base || n.baseURL, o = n.suffix; else {
        ...
        init: function (r) {
            ...
            var c = function (e) {
                ...
                qw.unbind(window, "ready", e), function (e) {
                    var t = r[e];
        ...
        add: function (e) {
            var t = this;
            return Gw[e.id] === e || (null === t.get(e.id) && ("length" !== e.id && (Gw[e.id] = e), Gw.push(e), Jw.push(e)), Zw(!0), t.activeEditor = e, t.fire("AddEditor", {editor: e}), _w || (_w = function () {
                t.fire("BeforeUnload")
    ...
    var oN, iN, aN = rN, uN = Math.min, sN = Math.max, cN = Math.round, lN = function (e, t, n) {
        var r, o, i, a, u, s;
        ...
        }, relativePosition: lN, findBestRelativePosition: function (e, t, n, r) {
            var o, i;
        ...
        }, create: fN, fromClientRect: function (e) {
        ...
        add: function (e, t) {
            ...
            var t = e.toLowerCase(), n = mN.hasOwnProperty(t) ? mN[t] : null;
    ...
    }, pN = Yt.each, hN = Yt.extend, vN = function () {
    };
    ...
    var bN = Math.min, yN = Math.max, CN = Math.round, xN = function (e, n) {
        var r, o, t, i;
        ...
        callbacks: {}, count: 0, send: function (t) {
            var n = this, r = gi.DOM, o = t.count !== undefined ? t.count : n.count, i = "tinymce_jsonp_" + o;
        ...
        send: function (e) {
            ...
            if (e.scope = e.scope || this, e.success_scope = e.success_scope || e.scope, e.error_scope = e.error_scope || e.scope, e.async = !1 !== e.async, e.data = e.data || "", EN.fire("beforeInitialize", {settings: e}), t = Tp()) {
    ...
    Yt.extend(EN, Rg);
    var SN, kN, TN, AN, RN = Yt.extend, _N = function (e) {
    ...
    DN = PN, window.tinymce = DN, window.tinyMCE = DN, function (e) {
