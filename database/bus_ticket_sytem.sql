...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=612976584ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="177">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bus_ticket_sytem&table=booked">`bus_ticket_sytem`.`booked`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bus_ticket_sytem&table=route">`bus_ticket_sytem`.`route`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bus_ticket_sytem&table=schedule_list">`bus_ticket_sytem`.`schedule_list`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bus_ticket_sytem&table=bus">`bus_ticket_sytem`.`bus`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bus_booking&table=location">`bus_booking`.`location`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bus_booking&table=schedule_list">`bus_booking`.`schedule_list`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sbtbsphp&table=routes">`sbtbsphp`.`routes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sbtbsphp&table=seats">`sbtbsphp`.`seats`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bus_ticket_sytem&table=user">`bus_ticket_sytem`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sbtbsphp&table=customers">`sbtbsphp`.`customers`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="66334f3e3a445b7352747b5b5028372a">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="177"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="bus_ticket_sytem" targettable="route">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `route`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bus_ticket_sytem" targettable="booked">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">TRUNCATE TABLE booked;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bus_ticket_sytem" targettable="route">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">TRUNCATE TABLE route;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="bus_ticket_sytem" targettable="booked">
                            <div class="action_content">
